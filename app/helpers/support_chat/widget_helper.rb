...
module SupportChat
  module WidgetHelper
    def chatkit_widget(options = {})
      ...
      # Load widget assets using asset pipeline helpers for proper fingerprinting
      html = <<~HTML
        <link rel="stylesheet" href="#{asset_path('support_chat/widget.css')}" />
        ...
        <script src="#{asset_path('support_chat/widget.js')}"></script>
      HTML
